"""
Django settings for anonymous_social_question_answer project.
...
ROOT_URLCONF = 'anonymous_social_question_answer.urls'
...
WSGI_APPLICATION = 'anonymous_social_question_answer.wsgi.application'

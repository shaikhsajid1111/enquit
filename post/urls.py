...
urlpatterns = [
    ...
    path("saved/<page_number>", views.view_saved, name="saved"),
    ...
    path("tag/<tag>", views.blank_route_tag, name="tag_view_blank"),
    path("tag/<tag>/<page_number>",views.view_by_tag,name="tag_view")
]
